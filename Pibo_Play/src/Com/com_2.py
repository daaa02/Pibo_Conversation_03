...
sys.path.append('/home/pi/Pibo_Package_03/Pibo_Play/')
    ...
    def com_2(self):
        ...
        while True:
            ...
            if len(self.animal) != 0:
                ...
                audio.audio_play(filename="/home/pi/Pibo_Package_03/Pibo_Play/data/behavior/audio/sound_magician.wav", volume=-1500, background=False)
